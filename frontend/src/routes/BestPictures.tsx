  ...
  return (
    <Card withBorder padding="md" radius="md">
      <Card.Section style={{ position: "relative" }}>
        ...
        {pinned ? (
          <HintTooltip label={pinned} multiline w={280}>
            <Badge
  ...
  return (
    <Stack>
      <Group gap="xs">
        ...
        {items.length > 0 ? (
          <HintTooltip label="Your finest finished stacks across every target, picked automatically by total integration time, cleanliness, and frame count.">
