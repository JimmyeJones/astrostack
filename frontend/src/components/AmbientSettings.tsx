    ...
    <Paper withBorder p="lg">
      <Stack>
        ...
        <Text size="sm" c="dimmed">
          A quiet, slow-pulsing chill soundbed for long sessions watching a
          stack run or browsing the gallery — a soft heartbeat under a wide,
          dark pad, with echoes that drift off into the dark. It is generated in
          your browser as it plays — nothing is downloaded and no two minutes
          sound the same. Off unless you turn it on with the speaker button in
          the top bar, and remembered for this device only (on the lounge PC,
          off on your phone).
        </Text>
        <div>
