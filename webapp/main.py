...
from webapp.routers import (
    auth as auth_router,
    calibration, editor, frames, gallery, jobs, lifelist, logs, newsubs, overtrim, plan,
    sample, seestar, settings, sky, stack, stackfailures, stats, storage, system, targets,
    upload, video, wishlist,
)
